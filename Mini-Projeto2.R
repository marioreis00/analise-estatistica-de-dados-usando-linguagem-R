...
setwd("C:/Users/Mário/Documents/PowerBI/cap12mproj")
getwd()
...
# Tarefa 3 Construir um gráfico mostrando a relação de duas variavéis numericas para as 3 categorias de uma varíavel categórica.
library(ggplot2)
